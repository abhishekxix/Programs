// 4. Explain the situation when ambiguity is occurred in inheritance with the help of
//    program.
// Ans.
    #include <iostream>
    ...
    class Derived : public Base_1, public Base_2 {  //Multiple inheritance ambiguity
    ...
    int main() {
        ...
        object.say_hello_L();
        Derived o;
        o.Base_1::do_something();
        o.Base_2::do_something();
        return 0;
    }
