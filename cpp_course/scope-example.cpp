...
int main()
{
    ...
    {//creates a new level of scope
        ...
        cout << "Local num is " << num << " in inner block in main." << endl
             << "Inner block in main can see outside - num1 is " << num1 << endl;
    }
    cout << "Local num is " << num << " in main." << endl;
...
void local_example(int x)
{
    ...
    //num1 of main is not within scope of this function - so it can't be used here.
}
...
void static_local_example()
{
    ...
    num += 1000;
    cout << "Local static num is " << num << " in staic_local_example() - end" << endl;
}