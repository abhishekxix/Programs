...
public class Main {
    ...
    private static final Map<Integer, Location> locations = new HashMap<>();    //marking an object as final means that it cannot be assigned a new reference down the road.
