...
def infer(use_cuda, params_dirname):
    ...
    with fluid.scope_guard(inference_scope):
        ...
        assert feed_target_names[3] == "location_id"
        ...
        assert feed_target_names[6] == "job_title"
        ...
        print("Predict Rating of user id 1 on job id 783 is " + str(predict_rating[0][0]))
        print("Actual Rating of user id 1 on job id 783 is 4.")
